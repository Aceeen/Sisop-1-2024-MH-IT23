...
function authenticate_user() {
    ...
    echo "$(date '+[%d/%m/%y %H:%M:%S]') [LOGIN SUCCESS] User $email berhasil log in." >> /home/syahrhm/sisop/mod1no2/auth.log
...
function edit_user() {
    ...
    if grep -q "^$email:" /home/syahrhm/sisop/mod1no2/users.txt; then
        ...
        if [ -n "$new_username" ]; then
            sed -i "s/^$email:[^:]*:/&$new_username:/" /home/syahrhm/sisop/mod1no2/users.txt
        ...
        if [ -n "$new_password" ]; then
            ...
            sed -i "s/^$email:[^:]*:[^:]*:/&$encrypted_password:/" /home/syahrhm/sisop/mod1no2/users.txt
...
function remove_user() {
    ...
    if grep -q "^$email:" /home/syahrhm/sisop/mod1no2/users.txt; then
        ...
        sed -i "/^$email:/d" /home/syahrhm/sisop/mod1no2/users.txt
